...
# np.savetxt("BA_Q_actions.csv",store_actions, delimiter=",")
# np.savetxt("BA_Q_port.csv",portfolio, delimiter=",")
# ########################################
# DISPLAY CODE 
########################################
...
def randomWalk(stock):
    ...
    np.savetxt("BA_random_actions.csv",store_array, delimiter=",")
    np.savetxt("BA_random_port.csv",portfolio, delimiter=",")
    return portfolio
